...
#/
proc queueAudio*(dev: AudioDeviceID, data: pointer, length: uint32): cint {.importc:
  "SDL_QueueAudio".}
...
#  \sa SDL_ClearQueuedAudio
#/
proc dequeueAudio*(dev: AudioDeviceID, data: pointer, length: uint32): uint32 {.importc:
  "SDL_DequeueAudio".}
...
#  \sa SDL_ClearQueuedAudio
#/
proc getQueuedAudioSize*(dev: AudioDeviceID): uint32 {.importc:
...
#  \sa SDL_GetQueuedAudioSize
#/
proc clearQueuedAudio*(dev: AudioDeviceID) {.importc:
